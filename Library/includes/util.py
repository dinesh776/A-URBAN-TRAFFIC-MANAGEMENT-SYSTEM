...
def write_csv(results, output_path):
    ...
    with open(output_path, 'w') as f:
        f.write('{},{},{},{},{},{},{},{},{},{},{},{}\n'.format('license_number','location','Date','Time','car_image_path','line_crossed','car_id','license_number_score','frame_nmr','car_bbox',
                   ...
                   'text' in results[frame_nmr][car_id]['license_plate'].keys():
                    ...
                    f.write('{},{},{},{},{},{},{},{},{},{},{},{}\n'.format(
                        results[frame_nmr][car_id]['license_plate']['text'],
                                                                  ...
                                                                  current_date,
                                                            current_time,
                                                            results[frame_nmr][car_id]['car']['image_path'],
                                                            results[frame_nmr][car_id]['crossed_line'],
                                                            car_id,
...
def license_complies_format_IND(text):
    """
    Check if the license plate text complies with the required format.
...
def format_license_UK(text):
    ...
    """
    license_plate_ = ''
    # Apply the character conversion mappings
    mapping = {0: dict_int_to_char, 1: dict_int_to_char, 4: dict_int_to_char, 5: dict_int_to_char, 6: dict_int_to_char,
...
def read_license_plate(license_plate_crop):
    ...
    for detection in detections:
        ...
        if license_complies_format_UK(text) is False:
            if license_complies_format_IND(text):
                return format_license_IND(text), score
        else:
            return format_license_UK(text), score
